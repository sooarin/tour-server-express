...
export const ERRCODE_KR = {
    ...
    ERR001: "회원가입에 실패하였습니다.",
    ERR00101: "이미 존재하는 이메일입니다.",
    // ERR002의 경우도 Passport가 영어 메시지를 발생시키기 때문에,
    // 에러를 뭉뚱그려서 로그인 실패의 형태로 명세하였음.
    ERR002: "이메일과 패스워드를 다시 확인해주세요.",
    ERR00202: "이메일과 패스워드를 입력해 주십시오.",
    ERR003: "데이터베이스와 연결되지 않았습니다.",
    ERR004: "사용자가 일치하지 않습니다.",
    ERR005: "데이터가 존재하지 않습니다.",
    ERR006: "이미 좋아요 설정 하였습니다.",
    ERR007: "이미 좋아요 해제 하였습니다.",
}